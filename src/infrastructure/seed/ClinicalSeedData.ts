...
export interface Icd10ProcedureMap {
  ...
  relationship: 'primary' | 'common' | 'related'
}
...
export const PROCEDURE_CODES: ProcedureCode[] = [
  ...
  // ── Chemotherapy ───────────────────────────────────────────────────────
  { code: '96409', description: 'Chemotherapy administration; intravenous, push technique, single or initial substance', category: 'Oncology', medicareRate: 161.29, typicalCharge: 985.00, eligibilityFee: 117.28, nonFacilityFee: 161.29, rvuWork: 0.17, rvuTotal: 2.56 } as never,
...
export const ICD10_PROCEDURE_MAPS: Omit<Icd10ProcedureMap, never>[] = [
  // Diabetes
